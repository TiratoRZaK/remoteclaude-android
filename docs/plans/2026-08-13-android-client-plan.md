...
Статус: выполнен. 76 JVM-тестов зелёные, debug-APK собран, приложение проверено на
эмуляторе против живого сервера — подключение, список сессий, чат, терминал, панель
клавиш, композер, плашка меню, «Под экран», завершение сессии с кодом.
